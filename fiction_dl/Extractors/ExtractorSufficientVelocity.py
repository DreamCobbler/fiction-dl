...
##
#
# Extractor designed for SufficientVelocity.com. Internally it uses the XenForo extractor.
#
##

class ExtractorSufficientVelocity(ExtractorXenForo):
    ...
    def __init__(self) -> None:
        ...
        super().__init__("https://forums.sufficientvelocity.com/")
