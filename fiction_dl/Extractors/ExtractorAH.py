...
##
#
# Extractor designed for AlternateHistory.com. Internally it uses the XenForo extractor.
#
##

class ExtractorAH(ExtractorXenForo):
    ...
    def __init__(self) -> None:
        ...
        super().__init__("https://www.alternatehistory.com/forum/")
